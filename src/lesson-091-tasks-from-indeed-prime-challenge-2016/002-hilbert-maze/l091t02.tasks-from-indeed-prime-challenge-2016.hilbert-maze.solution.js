 ...
 *
 * A halfling is searching for treasure hidden in a maze in the dwarfs' mine. He has a map of the maze and would like
 * to find the shortest path to the treasure.
 *
 ...
 * clockwise and the maze in the bottom-right quarter is rotated by 90 degrees counter-clockwise. The mazes in the top quarters
 ...
 *
 * that, given the size of the maze N, coordinates of the halfling (A, B) and coordinates of the treasure (C, D), returns the minimum
 * number of steps required for the halfling to reach the treasure.
 *
 * Examples
