 ...
 * There is a number written on each square. A non-empty  array A of N integers contains the numbers written
 ...
 * which shows on the upper face after the die comes to rest. Then we move the pebble standing on square number I
 * to square number I + K, providing that square number I + K exists. If square number I + K does not exist,
 ...
 * The marked squares are 0, 3 and 5, so the result of the game is 1 + 9 + (−2) = 8. This is the maximal possible
 * result that can be achieved on this board.
 *
 * Write a function:
 *
 * function solution(A);
