 ...
 * the spaces. The goal is to choose the longest word that is a valid password. You can assume that if there are K spaces in
 ...
 * Note that neither "test" nor "?xy1" is a valid password, because "?" is not an alphanumerical character and "test" contains
 * an even number of digits (zero).
 *
 * Write a function:
 *
 * function solution(S);
 *
 * that, given a non-empty string S consisting of N characters, returns the length of the longest word from the string that is
 * a valid password. If there is no such word, your function should return −1.
 *
